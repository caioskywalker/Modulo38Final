...
import br.com.cfarias.domain.ProdutoQuantidade;
...
public class VendaController implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3055427045983526802L;
...
private Venda venda;
    ...
    public void onRowCancel(RowEditEvent<ProdutoQuantidade> event) {
        FacesMessage msg = new FacesMessage("Edit Cancelled", String.valueOf(event.getObject().getIdProdutoQuantidade()));
