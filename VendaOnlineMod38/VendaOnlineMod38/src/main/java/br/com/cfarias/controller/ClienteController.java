...
import br.com.cfarias.utils.ReplaceUtils;
...
public class ClienteController implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1483298162042801219L;
	...
	public void edit(Cliente cliente) {
		try {
			...
			FacesContext.getCurrentInstance().addMessage("growl", new FacesMessage("Erro ao tentar exclui o cliente"));
		}
	}
